...
export class EditTaskComponent implements OnInit {
  ...
  task:Task[] =[];
   ...
   constructor(private jsonService:JsonService, private toasterService:ToastrService , private cookieService :CookieService) { 
     ...
     this.taskSelected = new Task(0,"---Select any of the Parent Task from the dropdown---",0,null,null,null);
   ...
   formHandler(){
    ...
    insertData(data:any){
      ...
      if(!data.parentTask || data.parentTask.task == "---Select any of the Parent Task from the dropdown---" )
